    ...
    private static func seedDefaultStaplesIfNeeded(context: ModelContext) {
        ...
        if count == 0 {
            let defaults: [SavedFavoriteMeal] = [
                ...
                SavedFavoriteMeal(name: "Bowl of Oats & Berries", mealSlot: "Breakfast", calories: 350, proteinGrams: 11, carbsGrams: 60, fatsGrams: 6, servingDescription: "1 medium bowl", icon: "bowl.fill", isPinned: true, useCount: 0),
